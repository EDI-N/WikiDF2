...
.. attention:: 
    За замовчуванням комплект документів створюється зі статусом "Чорновик" і для подальшої корректної роботи його необхідно `активувати <https://wiki-df-bank.edin.ua/uk/latest/API_DOCflow/Methods/ChangePackageTypeStatus.html>`__ !!! 

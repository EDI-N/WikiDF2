...
.. _«Інструкції з авторизації»: https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-avtorizatsia.html
...
`Ознайомтеся з інструкцією з з налаштування ЕЦП/КЕП для підписання! <https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-nastroyka-ecp.html>`_ .
...
.. _«Інструкції користування пошуком та фільтрами»: https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/%D1%96nstrukc%D1%96ya-koristuvannya-poshukom.html
...
У *Налаштування компанії - Налаштування комплектів документів*, при `додаванні звязку комплекта з типами документів <https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-biznes-administratora.html#pack_with_docs>`_  можливо налаштувати правила роботи з документом.
...
.. _`Маршрути погодження`: https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-biznes-administratora.html#id18

.. _`Відображення штампу ЕЦП у листі підписання`: https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-biznes-administratora.html#id9

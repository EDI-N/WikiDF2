...
Інформація шодо підписання шифрованих документів та додавання шифрованих документів описана в інструкції `Підписання шифрованих документів <https://wiki-df.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-nastroyka-ecp.html#id10>`__ .

...
Для авторизації на платформі перейдіть за посиланням http://doc.edin.ua/auth та введіть свої логін = email і пароль на формі авторизації. Детальна інформація з авторизації міститься в  `«Інструкції з авторизації»`_.
...
Інформація шодо підписання шифрованих документів та додавання шифрованих документів описана в інструкції `Підписання шифрованих документів <https://wiki-df-bank.edin.ua/uk/latest/EDIN_DOCflow/edin_docflow/instruktsia-nastroyka-ecp.html#id10>`__ .
